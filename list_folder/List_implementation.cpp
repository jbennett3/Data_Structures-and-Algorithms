...
List::List(const List &p_List)//reference name for list object
{
	Node* current = p_List.first->next;
	Node* newCopy = new Node(p_List.first->data);
	first = newCopy;
	while (current != nullptr) {
		newCopy->next = new Node(current->data);
